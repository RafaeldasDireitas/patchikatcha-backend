        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserCurrency = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryTag = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstItem = table.Column<int>(type: "integer", nullable: false),
                    AdditionalItems = table.Column<int>(type: "integer", nullable: false),
                    BlueprintId = table.Column<int>(type: "integer", nullable: false),
                    PrintProviderId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2140a1ac-df7e-4c4e-b3aa-8ce26caed657", "2140a1ac-df7e-4c4e-b3aa-8ce26caed657", "Admin", "ADMIN" },
                    { "27ea9bea-80cd-4080-b486-59a1527c5bb1", "27ea9bea-80cd-4080-b486-59a1527c5bb1", "User", "USER" }
                });
